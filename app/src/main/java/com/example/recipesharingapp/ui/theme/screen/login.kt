...
import com.example.recipesharingapp.ui.screens.navigation.NavigationDestination
import com.example.recipesharingapp.ui.screens.navigation.UserAppBar
...
fun LoginScreenWithTopBar(
    ...
    Scaffold(
        bottomBar = { UserAppBar(titleScreen = LoginDestination.title, canNavigateBack = false)}
    ){
